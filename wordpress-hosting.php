...
<body>
    <!-- Default Page Header -->
    <div class="default-header wordpress-page">
...
<div class="pricing-tables white-bg custom-pricing padding-top50 padding-bottom50" id="prezzi">
            ...
            <div class="row">              
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <div class="table">                    
                        <div class="table-content">
                            <h2>Caterpillar</h2>
                            <p>Designed for WordPress Start</p>
                            <div class="table-list">
								...
								<a href="features/hosting-wordpress.php"><p style="font-size:20px;"><b>More Features</b></p></a>
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <div class="table">                     
                        <div class="table-content">
                            <h2>Chrysalis</h2>
                            <p>Designed growth your WP Website</p>
                           <div class="table-list">
                                <ul>                           
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <div class="table">
                        <div class="table-content">
                            <h2>Butterfly</h2>
                            <p>Designed to make you WP fly</p>
                            <div class="table-list">
                                <ul>                           
                                    <li><i data-aos="zoom-in" data-aos-delay="50" class="fa fa-plus"></i> <p style="font-size:20px;"><b>Unlimited</b> Website</p></li>
	...
	<p style="text-decoration:underline;"><a href="features/hosting-wordpress.php">Compare plans and view all features.</a></p>
	</div>
        ...
        <div class="custom-width">
            <div class="row">
                <div class="main-title title-white text-center">
                    <h2>WordPress webmaster tools</h2>                 
                </div>
                <div class="col-sm-6">
                    <div class="left-content">
                        ...
                        <div class="features">
                            <i class="fab fa-wordpress pull-left aos-init aos-animate" data-aos="zoom-in" data-aos-delay="200"></i>
                            <div class="text">
                                <h4>Free WordPress Migrator</h4>
                    ...
                    <div class="right-content">
                        ...
                        <div class="features">
                            ...
                            <div class="text">
                                ...
                                <p>Use advanced capabilities like SSH and WP-CLI access, GIT integration, PHP version management and much more.</p>
                                <p></p>
                            </div>
                        </div>
                        <div class="features">
