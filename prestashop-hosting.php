...
<body>
    <!-- Default Page Header -->
    <div class="default-header prestashop-page">
        <div class="custom-width">
            <div class="row">
                <div class="col-sm-7">
                    <div class="header-text">
                        <h2>Managed PrestaShop Hosting</h2>
                        <p>If your PrestaShop website is your passion, business or just a personal hobby, <br>we want you to succeed and grow.</p>
...
<div class="pricing-tables white-bg custom-pricing padding-top50 padding-bottom50" id="prezzi">
            ...
            <div class="row">              
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <div class="table">                    
                        <div class="table-content">
                            <h2>Caterpillar</h2>
                            <p>Designed for PrestaShop Start</p>
                            <div class="table-list">
								...
								<a href="features/hosting-PrestaShop.php"><p style="font-size:20px;"><b>More Features</b></p></a>
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <div class="table">                     
                        <div class="table-content">
                            <h2>Chrysalis</h2>
                            <p>Designed growth your PS Website</p>
                           <div class="table-list">
                                <ul>                           
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <div class="table">
                        <div class="table-content">
                            <h2>Butterfly</h2>
                            <p>Designed to make you PS fly</p>
                            <div class="table-list">
                                <ul>                           
                                    <li><i data-aos="zoom-in" data-aos-delay="50" class="fa fa-plus"></i> <p style="font-size:20px;"><b>Unlimited</b> Website</p></li>
	...
	<p style="text-decoration:underline;"><a href="features/hosting-PrestaShop.php">Compare plans and view all features.</a></p>
	</div>
        ...
        <div class="custom-width">
            <div class="row">
                <div class="main-title title-white text-center">
                    <h2>PrestaShop webmaster tools</h2>                 
                </div>
                <div class="col-sm-6">
                    <div class="left-content">
                        ...
                        <div class="features">
                            <i class="fas fa-shopping-bag pull-left aos-init aos-animate" data-aos="zoom-in" data-aos-delay="200"></i>
                            <div class="text">
                                <h4>Free PrestaShop Migrator</h4>
                    ...
                    <div class="right-content">
                        ...
                        <div class="features">
                            ...
                            <div class="text">
                                ...
                                <p>Use advanced capabilities like SSH and PS-CLI access, GIT integration, PHP version management and much more.</p>
                                <p></p>
                            </div>
                        </div>
                        <div class="features">
