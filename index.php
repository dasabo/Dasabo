                ...
                <div class="row">
                    <div class="tab-content">
                        <div id="wordpress" class="tab-pane fade in active">
                            <div class="col-sm-6">
                                <div class="text-container">
                                    <div class="home-title animated fadeInLeft">
                                        <h2>Powerful Website Hosting dav suca</h2>
                            ...
                            <div class="col-sm-6">
                                <div class="img-container">
                                    <img src="images/png-images/home-carousel.png" class="img-responsive animated fadeInRight" alt="">
                                </div>
                            </div>
                        </div>
                        <div id="cloud" class="tab-pane">
                            ...
                            <div class="col-sm-6">
                                <div class="img-container">
                                    <img src="images/png-images/green-energy.png" class="img-responsive animated fadeInRight" alt="">
                                </div>
                            </div>
                        </div>
                        <div id="dedicated" class="tab-pane fade">
                            ...
                            <div class="col-sm-6">
                                <div class="img-container">
                                    <img src="images/png-images/server2.png" class="img-responsive animated fadeInRight" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div class="text">
                            ...
                            <p>Get your perfect domain name starting from <font color="#ffffff"><strong>€1.99</strong></font> for the first year and free domain privacy included</p>
                        </div>
                    </div>
                    <div class="col-sm-7">
