...
<head>
    ...
    <meta name="description" content="Hosting of self-installing Magento with various management tools.">
...
<?php include 'inc/header.php'; ?>
    ...
    <body>
        ...
        <header class="masthead  content  content-blue-gradient">
            <div class="grid">
                <div class="masthead-content  content-pad">
                    <h1 class=""><p>UltraFast Magento Hosting</p></h1>

                    <p>Guaranteed to make your Magento site run quicker on our optimised stack, or your money back.</p>
            ...
            <div class="grid">
                ...
                <header class="content-intro">
                    ...
                    <div class="content-split-copy">
                        <h1>Ultimate  Magento Hosting, without the restrictions.</h1>

                        <p>Our <strong>dasabo Shared</strong>, <strong>Reseller</strong> and <strong>Dedicated</strong> <strong>Magento</strong> hosting is expertly optimised to deliver exceptional TTFB/TTLB (Time To First &amp; Last Byte) speeds. </p>
                ...
                <div class="full">
                    ...
                    <div class="triple-item  item-icon-before  item-icon-medium">
                        ...
                        <p>We're so confident that our Magento hosting is better than regular hosting, that we'll refund your money if it's not.
                    ...
                    <div class="triple-item  item-icon-before  item-icon-medium">
                        ...
                        <h3 class="margin-none">Magento Friendly Security</h3>
                        <p>Our Web Application Firewall protects your Magento site without causing disruption.
                    ...
                    <div class="triple-item  item-icon-before  item-icon-medium">
                        ...
                        <p>We provide a simple web-based auto-install, auto-upgrade and auto-clone of Magento, as well as fully updated wp-cli access and git for easy version control.
                    ...
                    <div class="triple-item  item-icon-before  item-icon-medium">
                        ...
                        <h3 class="margin-none">Magento Multisite Support</h3>
                        <p>Our packages include full Magento Multisite support as standard.
                    ...
                    <div class="triple-item  item-icon-before  item-icon-medium">
                        ...
                        <p>All Magento hosting can be dynamically distributed throughout our 100Gigabit cloud network, balancing demand and improving performance.
        ...
        <section class="content  content-pad  content-dblue" id="order">
            <div class="grid-wide">
                <h1 class="center  margin-double-mq">Activate your Magento hosting in minutes.</h1>
        ...
        <section class="content-pad animateme content-lblue active" id="performance">
            <div class="grid">
                <h1 class="margin-double-mq">Magento Hosting Performance</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="text-container aos-init aos-animate" data-aos="fade-up">
                            <h3>Automatic Magento Install</h3>
                            <div class="text-content">
                                <i class="far fa-check-circle pull-left"></i>
                                <div class="text">
                                    <p>Through Magento packages, your site will be installed automatically in a few moments.</p>
                                </div>
                            </div>
                            <div class="text-content">
                                <i class="far fa-check-circle pull-left"></i>
                                <div class="text">
                                    <p>Manage your Magento site, through a simple and intuitive interface and save time to dedicate to your project!</p>
                                </div>
                            </div>
                            <div class="buttons">
        ...
        <section class="content content-pad content-medblue" id="faqs">
            <div class="grid">
                <h1 class="margin-double-mq">Magento Hosting FAQs</h1>
